...
def apply_rotary_pos_emb(q, k, cos, sin, ca_cos=None, ca_sin=None, position_ids=None, unsqueeze_dim=1, is_cross_attention=False):
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        encoder_hidden_states: Optional[Union[torch.Tensor, Tuple[torch.Tensor]]] = None,
        retrieval_position: Optional[torch.LongTensor] = None,
        knowledge_outputs: Optional[Union[Tuple[Tuple[torch.Tensor]], Tuple[torch.Tensor]]] = None,
...
class LlamaWithRetrievalHeadForCausalLM(LlamaPreTrainedModel):
    _tied_weights_keys = ["lm_head.weight"]
...
class LlamaWithRetrievalHeadAndKnowledgeInjectorForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        if knowledge_input_ids is not None and knowledge_outputs is None:
            ...
            print(f'knowledge_outputs shape: {knowledge_outputs.shape}')
