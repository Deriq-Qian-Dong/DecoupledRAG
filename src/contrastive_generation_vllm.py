...
def initialize_llm(model_path, tensor_parallel_size, batch_size):
    return LLM(model=model_path, tensor_parallel_size=tensor_parallel_size, max_num_seqs=batch_size, max_num_batched_tokens=batch_size, gpu_memory_utilization=0.99)
