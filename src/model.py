...
class RAGForCausalLM(nn.Module):
    def __init__(self, train_config):
        ...
        if os.path.exists(os.path.join(train_config['kg_model_name_or_path'], 'adapter_config.json')):
            ...
            model.model.add_adapter("knowledge_injector", peft_config=peft_config)
    ...
    def save_pretrained(self, directory):
        ...
        gate_scores = torch.tensor(gate_scores)
        torch.save(gate_scores, f"{directory}/gate_scores.pt")
